...
const Banner = ({ imglink, heading, para }) => {
  return (
    <motion.div
      ...
      className="relative w-full h-100 overflow-hidden" // Increased height here
    >
      <img src={imglink} alt="Banner" className="w-full h-full object-cover" />
      {/* <div className="absolute inset-0 flex flex-col justify-center items-center bg-black bg-opacity-0 text-white p-4">
