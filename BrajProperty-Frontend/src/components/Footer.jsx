...
const Footer = () => {
  return (
    <div className="w-[99vw] py-16 border-black border-2 bg-[#101225] min-h-[300px] px-[5%]  flex flex-row justify-center items-center content-center gap-x-20 gap-y-10 flex-wrap box-border">
      <div className=" flex-col justify-center  text-[#b4973a]  min-w-[350px] max-w-[400px] p-4">
      ...
      <div className="  text-[#b4973a] p-4 flex flex-col justify-around min-w-[300px] text-center font-poppins font-medium gap-y-1">
      ...
      <div className="  text-[#b4973a] p-4 font-poppins flex flex-col gap-y-4 font-medium text-lg text-center items-center content-center">
